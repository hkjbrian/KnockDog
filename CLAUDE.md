...
1. **워크플로우**: 작업은 `docs/issue-driven-workflow.md`를 따른다 (이슈 먼저 → `feature/#<이슈>-<slug>` 브랜치 → PR `Closes #N`, `main` 직접 작업 금지).
...
| [docs/submission-guide.md](docs/submission-guide.md) | 과제 요구사항 대응 · 전체 흐름도 · 제출 전 검증 목록 |
...
| [docs/issue-driven-workflow.md](docs/issue-driven-workflow.md) | 이슈 기반 개발 프로세스 (Milestone↔epic · 이슈→브랜치→PR · Closes 제약) |
